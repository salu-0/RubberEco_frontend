        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <div>
                <h2 className="text-2xl font-bold text-gray-900">Tree Lot Management</h2>
                <p className="text-gray-600 mt-1">Manage your rubber tree lots for bidding</p>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    <h3 className="text-xl font-bold text-gray-900">My Tree Lots</h3>
                    <p className="text-gray-600 mt-1">Manage your rubber tree lots for bidding</p>
                  </div>
        <motion.button
      ...
      <div className="space-y-4">
        {treeLots.length === 0 ? (
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">No tree lots yet</h3>
            <p className="text-gray-600 mb-4">Start by listing your first rubber tree lot for bidding</p>
            <motion.button
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm text-gray-600">{lot.numberOfTrees} trees</span>
                        </div>
                        <div className="flex items-center space-x-2">
                      ...
                      <div className="flex items-center space-x-4 text-sm text-gray-500">
                        <div className="flex items-center space-x-1">
                          ...
                          <span>{lot.viewCount || 0} views</span>
                        </div>
                        <div className="flex items-center space-x-1">
                          <Users className="h-4 w-4" />
                          <span>{lot.bidCount || 0} bids</span>
                        </div>
                        <div className="flex items-center space-x-1">
                          <Calendar className="h-4 w-4" />
                          <span>Ends {new Date(lot.biddingEndDate).toLocaleDateString()}</span>
                        </div>
                      </div>
                    </div>
