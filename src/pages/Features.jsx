...
const Features = () => {
  ...
  // Check if admin, staff, or broker user is trying to access features page
  useEffect(() => {
    ...
    if (isLoggedIn && user?.role === 'admin') {
      ...
      console.log('🚫 Broker user detected on features page, redirecting to broker dashboard');
